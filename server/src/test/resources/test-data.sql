...
INSERT INTO pet (user_id, pet_name, pet_nickname, pet_type, pet_birthday, notes, image_path)
    VALUES (1, 'name1', 'short1', 'type1', '2000-01-01', 'notes1', 'image1');
INSERT INTO pet (user_id, pet_name, pet_nickname, pet_type, pet_birthday, notes, image_path)
    VALUES (2, 'name2', 'short2', 'type2', '2000-02-02', 'notes2', 'image2');
INSERT INTO pet (user_id, pet_name, pet_nickname, pet_type, pet_birthday, notes, image_path)
    VALUES (3, 'name3', 'short3', 'type3', '2000-03-03', 'notes3', 'image3');
